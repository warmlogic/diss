...
As lag increases between repetitions it may become more difficult to retrieve the prior study event, but if a longer lag item is retrieved then the memory trace is strengthened to a greater extent \cite{DelaEtal2010}.  The processes underlying this are not specified in the literature, but this is essentially a description of the spacing effect and the mechanisms involved are part of the investigations performed in this thesis.
