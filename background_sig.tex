...
This is essentially a description of the spacing effect; some of the theories and models described below account for this (e.g., more contextual cues are stored at longer repetition lags), and the mechanisms involved are part of the investigations performed in this thesis.
