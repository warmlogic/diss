...
Additionally, there were SMEs only for spaced repetitions at medium (12) lags in both experiments, so it seems that while massed items are put at a disadvantage overall, memory is also better when semantic processing engages to a greater extent.
