...
We cannot evaluate results across modalities (ERP, time--frequency) in a vacuum, but they are also not directly comparable.  While the integration of results across modalities has the potential to explode combinatorically, we take a relatively conservative approach given the consistency of support for different hypotheses.
