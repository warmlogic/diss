...
For similarity differences, there was no three-way interaction between spacing, time, and memory, and the overall pattern of effects was complex and relatively unclear.

There were some effects we were able to see in Experiment~2 due to using multiple lags.  For the LPC, we found that SME decreases with lag, indicating that less information is consciously recognized at longer lags.  In the theta band for word presentations, examining the non-significant three-way interaction showed recalled long (32) spaced items showed more power than all other conditions, perhaps indicating why this condition is remembered best on average.
