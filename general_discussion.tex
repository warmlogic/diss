...
Through these results, it seems that the characterization of deficient processing as an ``impostor effect'' by \citeA{DelaEtal2010} does seem to be truthful: the pattern of results supporting deficient processing put massed items at a disadvantage rather than giving spaced items an advantage.
...
A final consideration regarding any effect that relies on a subsequent test is that the testing conditions will potentially have a profound impact on any kind of study-time manipulation, including spacing effects. Kahana. Green.  \hl{(TODO: should I write more about this, or am I opening up another can of worms?)}

\section{Future directions}

For future analyses, comparing the similarity of each image during the test/recall phase to its study presentations would be another way to examine memory reinstatement \cite{HowaKaha2002,LohnKaha2014b}.  This analysis would have a bearing on study-phase retrieval and contextual variability.
...
An interesting direction to take this would be to make EEG recordings in an established spacing effect paradigm from the literature \cite<e.g.,>[Experiment~1]{CepeEtal2009}.  This could involve a multi-session experiment so spacings could be longer, which would have the added benefit of being more applicable to real-world learning situations.  If deficient processing is eliminated, it would simplify the possibilities for why the spacing effect occurs.
