...
It again seems possible that the LPC indexes the information that is in working memory, and again, result does not seem to directly support any of the theories unless the match to working memory for massed items is an indicator for deficient processing to engage.
...
We still have no22t found the defining neural signature for why long spaced performance is best.
