...
The only difference compared to Experiment~1 is for image repetitions: the previous experiment showed that massed images were more negative only in the first time window.   This experiment showed that spaced images had a larger power decrease from the first to the second time window compared to massed images, though massed were still lower overall.  Perhaps the relative decrease during stimulus processing is an important factor in explanations of attentional effects, something that we expect to find a neural correlate for given that spaced items are remembered better than massed on average.
