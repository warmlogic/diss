...
Many of the effects described here are similar to Experiment~1.


It is interesting to contrast increased theta for long spaced items with the ERP LPC effects where massed items showed the most retrieval.  As was mentioned before, the LPC in this task may be related to information in working memory and may not necessarily reflect recollection.
