...
\subsection{EEG/ERP Basics}

\hl{Explain a bit about EEG here, including ERPs, power, desynchronization, etc.}
...
\hl{(Tim asked: Or could it just be an FN400 that gets more negative with decreasing oldness?)}
...
\hl{(Re: we would expect bigger old/new effects for massed, why don't we see any retrieval effects for spaced?)}
