...
In repetition paradigms the N400 ERP component (negative central peak) is associated with semantic priming and processing \cite{OlicEtal2000,VanSEtal2007}.  A more negative N400 is associated with more semantic unexpectedness.  Voltage for immediate repetitions is attenuated compared to initial presentations, and voltages becomes more negative as lag increases \cite{KimEtal2001}; this shows that spaced repetitions elicit semantic activation processes whereas this does not occur for massed repetitions when the information is still in working memory \cite{VanSEtal2007}.  We would expect this pattern under deficient processing.
