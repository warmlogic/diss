...
\cbstart
Contrary to predictions of the deficient processing hypothesis, the desynchronization of lower alpha suggests greater attention to massed items, though the overall timing of this effect compared to those of early attentional components should be considered.
\cbend
