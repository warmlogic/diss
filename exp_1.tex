...
All significant results are reported, and unreported results can be assumed to not be significant.
...
For latency, there was a significant interaction of spacing $\times$ presentation [$F(1,22)=7.5$, $p<.05$].  Massed repetitions ($M=563$~ms) peaked earlier than all other conditions (spaced repetition: $M=605$~ms; massed initial: $M=589$~ms; spaced initial: $M=597$~ms [$p$s~$<.005$]).    
