...
% \subsection{Application to specific aims}
...
There were also main effects of spacing [$F(1,22)=31.2, p=1.28e^{-5}$] and time [$F(1,22)=30.6, p=1.46e^{-5}$] following the same patterns, as well as a main effect of memory [$F(1,22)=6.1, p=.0217$] showing that less power is associated with subsequent recall ($M=-0.189$ \textit{vs.} $M=-0.067$).
