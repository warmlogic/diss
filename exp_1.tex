...
For the time--frequency analysis, the increase in similarity leading to the subsequent memory effects (three-way interaction) supports study-phase retrieval---or at least the engagement of the same processes---for both massed and spaced repetitions, especially toward the end of the trial.  No other spacing effect accounts seem to be supported with this analysis.
